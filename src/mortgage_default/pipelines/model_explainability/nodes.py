...
def generate_shap_report(
    ...
    model_uri = parameters.get("model_uri", "data/06_models/mlflow_model")
    metadata_path = Path(
        parameters.get(
            "metadata_path",
    ...
    target_col = metadata.get("target_column", "default")
    id_col = metadata.get("id_column", "loan_sequence_number")
    ...
    # SHAP needs numeric model input only.
